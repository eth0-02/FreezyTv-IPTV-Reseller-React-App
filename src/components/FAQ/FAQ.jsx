  ...
  return (
    <section className='faq-section'>
        <div className='faq'>   
            ...
            <Collapsible className='faq_collapsible' toggletitle="How Many Channel Do I Get?" toggledescription="Freezytv Provides around 20000+ live TV channels from the world in local and international languages. Instead of this, a user will also get 60,000 to 110,000+ VODS including TV Series, Movies, Dramas and so on."/>
